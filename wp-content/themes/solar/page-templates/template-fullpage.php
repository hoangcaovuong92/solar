...
do_action('tvlgiao_wpdance_before_main_content'); ?>
	...
	<div class="row wd-blog-page wd-main-content">
		<!-- Left Content -->
		...
		<div class="<?php echo esc_attr($content_class); ?>">
			<div id="primary" class="content-area">
				<main id="main" class="site-main">
					<?php $device = (tvlgiao_wpdance_is_mobile_or_tablet()) ? 'mobile' : 'desktop' ?>
					<div id="fullpage" data-device="<?php echo esc_attr($device); ?>">
