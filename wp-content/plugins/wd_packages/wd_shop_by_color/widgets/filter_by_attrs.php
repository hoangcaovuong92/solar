...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	if (!class_exists('tvlgiao_wpdance_widget_product_attrs_filter')) {
		class tvlgiao_wpdance_widget_product_attrs_filter extends WC_Widget {
			...
			protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
				// List display
				echo '<ul class="wd-product-filter-by-attr">';
