...
if(!function_exists ('tvlgiao_wpdance_transient_menu')){
	function tvlgiao_wpdance_transient_menu( $args = array() ) {
	    $defaults = array(
	        'menu' 				=> '',
	        'theme_location' 	=> '',
	        'echo' 				=> true,
...
add_action( 'wp_update_nav_menu', 'tvlgiao_wpdance_update_menus_transient' );
if(!function_exists ('tvlgiao_wpdance_update_menus_transient')){
	function tvlgiao_wpdance_update_menus_transient() {
...
if(!function_exists ('tvlgiao_wpdance_query_transient')){
	function tvlgiao_wpdance_query_transient($transient_key, $args) {
