	...
	function tvlgiao_wpdance_social_profiles_function($atts,$content){
		...
		$data_settings = array(
			'icon-facebook' => array(
				...
				'title'			=> esc_html__('Facebook', 'wpdancelaparis'),
				'desc'			=> esc_html__('Become our fan on facebook', 'wpdancelaparis'),
				'icon'			=> 'fa fa-facebook',
			...
			'icon-rss' 		=> array(
				'status'		=> $show_rss,
				'title'			=> esc_html__('Rss', 'wpdancelaparis'),
				'desc'			=> esc_html__('Rss', 'wpdancelaparis'),
				'icon'			=> 'fa fa-rss',
			...
			'icon-twitter' 	=> array(
				'status'		=> $show_twitter,
				'title'			=> esc_html__('Twitter', 'wpdancelaparis'),
				'desc'			=> esc_html__('Twitter', 'wpdancelaparis'),
				'icon'			=> 'fa fa-twitter',
			...
			'icon-google' => array(
				'status'		=> $show_google,
				'title'			=> esc_html__('Google', 'wpdancelaparis'),
				'desc'			=> esc_html__('Google', 'wpdancelaparis'),
			...
			'icon-pinterest' => array(
				'status'		=> $show_pin,
				'title'			=> esc_html__('Pinterest', 'wpdancelaparis'),
				'desc'			=> esc_html__('Pinterest', 'wpdancelaparis'),
			...
			'icon-youtube' => array(
				'status'		=> $show_youtube,
				'title'			=> esc_html__('Youtube', 'wpdancelaparis'),
				'desc'			=> esc_html__('Youtube', 'wpdancelaparis'),
				'icon'			=> 'fa fa-youtube',
			...
			'icon-instagram' => array(
				...
				'title'			=> esc_html__('Instagram', 'wpdancelaparis'),
				'desc'			=> esc_html__('Instagram', 'wpdancelaparis'),
