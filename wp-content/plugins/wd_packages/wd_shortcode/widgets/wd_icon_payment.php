...
if( !class_exists( 'tvlgiao_wpdance_widget_icon_payment' ) ) {
	class tvlgiao_wpdance_widget_icon_payment extends WP_Widget{
	    function __construct() {
			$widget_ops 		= array('classname' => 'widget_icon_payment', 'description' => esc_html__('Icon Payment Widget','wd_package'));
			$control_ops 		= array('width' => 400, 'height' => 350);
			parent::__construct('icon_payment', esc_html__('WD - Icon Payment','wd_package'), $widget_ops);
		}
	    function form( $instance )
	    {
	        ...
	        ?>
	            ...
	            <p>
	                <label for="<?php echo $this->get_field_id( 'list_icon_payment' ); ?>"><?php esc_html_e( 'List Icon Payment (Separated by commas):', 'wd_package' ); ?>
	                <input class="widefat" id="<?php echo $this->get_field_id( 'list_icon_payment' ); ?>" name="<?php echo $this->get_field_name( 'list_icon_payment' ); ?>" type="text" value="<?php echo $list_icon_payment; ?>" placeholder="<?php esc_html_e( 'Exam: fa-cc-mastercard, fa-cc-visa, fa-cc-amex, fa-cc-diners-club, fa-cc-discover, fa-credit-card-alt', 'wd_package' ); ?>" />
	                </label>
