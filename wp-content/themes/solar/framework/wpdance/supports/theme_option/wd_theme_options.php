<?php
    ...
    /*******************INCLUDE THEME OPTION PARTS*******************/
    foreach($wd_theme_option_parts as $part_name){
        if(file_exists(TVLGIAO_WPDANCE_THEME_OPTIONS."/parts/options_{$part_name}.php")){
            require_once TVLGIAO_WPDANCE_THEME_OPTIONS."/parts/options_{$part_name}.php";
        }
    }
    if ($include_demo) {
        include_once(TVLGIAO_WPDANCE_THEME_OPTIONS.'/parts/demo_data.php');
    }
    /****************************************************************/
