...
$(document).ready(function(){
	/*$('#documenter_nav > li').bind('click',function(){
		$('#documenter_nav > li').removeClass('active');
		$(this).addClass('active');
	});*/
	
	/*var _header_height = $('#documenter_header').outerHeight();
	
	jQuery("#documenter_menu").sticky({
					topSpacing: 0
					,topBegin: _header_height
				});*/
	...
	win.bind('scroll', function(){
		...
		if( scrollTop > 100 ){
			$('#documenter_menu .documenter_menu_content').addClass('affix').removeClass('affix-top');
		}
		else{
			$('#documenter_menu .documenter_menu_content').addClass('affix-top').removeClass('affix');
		}
	});
