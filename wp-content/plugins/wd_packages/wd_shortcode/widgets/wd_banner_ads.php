...
if( !class_exists( 'tvlgiao_wpdance_widget_banner_ads' ) ) {
	...
	function wp_widget_register_widget_banner_ads() {
		register_widget( 'tvlgiao_wpdance_widget_banner_ads' );
	}
	add_action( 'widgets_init', 'wp_widget_register_widget_banner_ads' );
}
?>